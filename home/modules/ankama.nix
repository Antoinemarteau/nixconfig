...
let
  ...
  src = fetchurl {
    ...
    hash = "sha256-SfK8zfWcxpILi6VGK72ja0WgIDIvZ4nOR70ToEt9rMk="; # Change for the sha256 you get after running nix-prefetch-url https://download.ankama.com/launcher/full/linux
